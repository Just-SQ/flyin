...
class Visualization:
    ...
    def draw_animated(self, turn: int, steps: int = 5) -> None:
        ...
        all_hubs = list(graph.hubs.values())  # V2: hubs is a name->Hub dict
        ...
        for step in range(steps + 1):
            ...
            for conn in graph.connections:
                h1 = graph.hubs[conn.hub1]  # V2: lookup via hubs dict
                h2 = graph.hubs[conn.hub2]
            ...
            for hub in all_hubs:
                ...
                color = _safe_color(hub.color)\
                    ...
                    hub.zone, DEFAULT_COLOR  # V2: zone is a plain string
                )
